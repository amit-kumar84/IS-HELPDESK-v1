...
<h2 height="73" colspan="2" style="text-align:center; font-size: 20px;text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue; color:#B1FF10;">&nbsp; Internet User List &nbsp;</h2>
<div>
		<?php
...
<table width="100%" height="54" border="1" cellpadding="1" cellspacing="0" style="float:left;" id="table_func">
      <tbody>
		 ...
		 <tr><td colspan="10" style="text-align:center; font-size:25px; background-color:#EBEBEB;">LAPTOP & PC</td></tr>
		...
		$s_no = 1 ;
		  ...
		  $hardware_master_sel=mysqli_query($link,"SELECT * FROM `hardware_master` WHERE (`USG`='NET' || `USG` LIKE '%NET%')  && (`CATG`='LAPTOP' || `CATG`='PC') ORDER BY IP_ADDRESS ");
        ...
        <tr style="text-align: left; font-size:12px" id="row_hov">
          ...
          <td><?php echo $hardware_master_arr["mac_address"] ; ?></td>
          <td><?php echo $hardware_master_arr["HD_ID_NO"] ; ?></td>
          <td><?php echo $hardware_master_arr["USG"] ; ?></td>
          <td><?php echo $hardware_master_arr["OS"] ; ?></td>
        </tr>
		...
		$s_no++ ;
		 ...
		 <!-- VDI-->
		 <tr><td colspan="10" style="text-align:center; font-size:25px; background-color:#EBEBEB;">VDI</td></tr>
		...
		$s_no = 1 ;
		  ...
		  $hardware_master_sel=mysqli_query($link,"SELECT * FROM `hardware_master` WHERE (`USG`='NET' || `USG` LIKE '%NET%')  && (`CATG`='VDI' ) ORDER BY IP_ADDRESS ");
		...
		$s_no++ ;
		 ...
		 <tr><td colspan="10" height="20"></td></tr>
		 <tr><td colspan="10" style="text-align:center; font-size:25px; background-color:#EBEBEB;">KISOK</td></tr>
...
<!--KIOSK-->
        ...
        <tr style="text-align: left; font-size:12px" id="row_hov">
          ...
          <td><?php echo $hardware_master_arr["mac_address"] ; ?></td>
          <td><?php echo $hardware_master_arr["HD_ID_NO"] ; ?></td>
          <td colspan="2"><?php echo $hardware_master_arr["USG"] ; ?></td>
        </tr>
		...
		$s_no++ ;
		 ...
		 <tr><td colspan="10" height="20"></td></tr>
		 <tr><td colspan="10" style="text-align:center; font-size:25px; background-color:#EBEBEB;">Printer</td></tr>
...
<!--Printer-->
		...
		$s_no = 1 ;
		  ...
		  $hardware_master_sel=mysqli_query($link,"SELECT * FROM `hardware_master` WHERE (`USG`='NET' || `USG` LIKE '%NET%')  && (`CATG`='PRINTER') ORDER BY  IP_ADDRESS, DEPT, SEC, STAFF_NO ");
		...
		$s_no++ ;
		 ...
		 <tr><td colspan="10" height="20"></td></tr>
		 <tr><td colspan="10" style="text-align:center; font-size:25px; background-color:#EBEBEB;">FIREWALL</td></tr>
...
<!--FIREWALL-->
		...
		$s_no++ ;
		 ...
		 <tr><td colspan="10" height="20"></td></tr>
		 <tr><td colspan="10" style="text-align:center; font-size:25px; background-color:#EBEBEB;">SWITCH</td></tr>
