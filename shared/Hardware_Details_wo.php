...
<h2 height="73" colspan="2" style="text-align:center; font-size: 20px;text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue; color:#B1FF10;">&nbsp; Write Off Assets List &nbsp;</h2>
<div>
...
<table width="100%" height="54" border="1" cellpadding="1" cellspacing="0" style="float:left;" id="table_func">
      <tbody>
		...
		$s_no = 1 ;
		  ...
		  $hardware_master_sel=mysqli_query($link,"SELECT * FROM `hardware_master` WHERE USG='WO' ORDER BY CATG, DEPT, SEC, USERNAME");
