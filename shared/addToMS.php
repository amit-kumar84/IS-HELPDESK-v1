...
if(isset($subm))
{
	if($HD_ID_NO != "")
	{
		...
		if(mysqli_query($link,"UPDATE `hardware_master` SET
								`STAFF_NO`='ISKOT',`USERNAME`='ISKOT', `DEPT`='M&ES', `SEC`='MIS', `USG`='MS (STANDBY)' WHERE `HD_ID_NO`='$HD_ID_NO' " ))
		{
			echo "<meta http-equiv='refresh' content='0'>";
...
<form id="form2" name="form2" method="POST">
    <table width="100%" border="0" align="center" cellpadding="1" cellspacing="0">	  
      ...
      <tr>
        <td colspan="5" style="text-align: center"><input type="submit" id="butt" name="subm" id="butt3" value="Return To MS"></td>
      </tr>
      </tbody>
    </table>
  </form>
